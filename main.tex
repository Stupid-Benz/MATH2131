...
%			\vfill
	...
	\noindent The notes is with reference to textbooks \citetitle{Friedberg2018-su} by \citeauthor{Friedberg2018-su}, \citetitle{artin_2018} by \citeauthor{artin_2018} and \citetitle{Fraleigh2002-ck} by \citeauthor{Fraleigh2002-ck}.
	...
	\begin{appendices}
		...
		\begin{definition}[Universal Properties]
			...
			\begin{center}
				...
				\end{tikzcd}
			\end{center}
			Such a property is called the \emph{universal property}\index{universal property} of the object $A$. Note that the dual version of universal morphism from $F$ to $X$ can be defined similarly.
		\end{definition}
		\begin{remark}
			...
			\begin{center}
				...
				\end{tikzcd}
			\end{center}
			The initial object in this category is exactly the object $A$ with the universal property.
			This type of construction is called the \emph{comma category}\index{comma category} and is denoted by $(X \downarrow F)$.
