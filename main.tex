...
\epigraph{Babies have to survive, so they have the strong desire to learn stuffs. You think you are not good at math because you don't have the strong desire to learn math.}{source}

\section{Linear Subspaces, Kernels and Images}

\begin{definition}[Linear Subspaces]
    Let $W$ be a linear space over $F$ and $V$ is a subset of $W$, denoted as $V \subset W$. $V$ is a (linear) subspace of $W$ if $V$, with $+$ and $\cdot$ inherited from those of $W$, is a linear space.
\end{definition}
...
\begin{definition}[Kernels]
    Let $f : V \to W$ be a linear map. The kernel of $f$, denoted as $\ker f$, is defined as 
    \[
...
\begin{definition}[Images]
    Let $f : V \to W$ be a linear map. The image of $f$, denoted by $\Im f$, is defined as 
    \[
...
\section{Linearly Independent Sets, Spanning Sets and Bases}\index{Linearly Independent Sets, Spanning Sets and Bases}
...
\begin{definition}[Linearly Independent Sets]
    The order set $S := \{\vec{v_1}, \vec{v_2}, \cdots, \vec{v_n}\} \subseteq V$ is said to be \emph{linearly independent} if the linear map $\phi_S: F^n \to V$ defined above is injective.
\end{definition}

\begin{definition}[Spanning Sets]
    The order set $S := \{\vec{v_1}, \vec{v_2}, \cdots, \vec{v_n}\} \subseteq V$ is said to be a \emph{spanning set} of $V$ if the linear map $\phi_S: F^n \to V$ defined above is surjective.
\end{definition}
