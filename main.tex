...
\begin{center}
    \begin{tikzcd}[row sep=huge, column sep=huge]
        & V \arrow[swap, dl, "S", hook, two heads] \arrow[dr, "T", hook, two heads] & \\
        F^n \arrow[rr, "TS^{-1}", hook, two heads] & & F^m
    \end{tikzcd}
\end{center}
...
\begin{center}
    \begin{tikzcd}[row sep=huge, column sep=huge]
        ...
        F^n \arrow[swap,r, "B", hook, two heads] & F^m
    \end{tikzcd}
\end{center}
...
\section{Linear Independent Sets and Spanning Sets}\index{Linear Independent Sets and Spanning Sets}

\begin{definition}[Linear Independent Sets]
...
\begin{center}
    \begin{tikzpicture}
        ...
        \draw[thick,ocre] (-2,-2) -- (2,2) node [right] {$V$};
        \draw[thick,red] (-2,-1) node [left] {$w_1 + V$} -- (1,2);
        \draw[thick,orange] (-2,0) node [left] {$w_2 + V$} -- (0,2);
        \draw[thick,magenta] (-2,1) node [left] {$w_3 + V$} -- (-1,2);
        \draw[thick,olive] (-1,-2) -- (2,1) node [right] {$w_4 + V$};
        \draw[thick,brown] (0,-2) -- (2,0) node [right] {$w_5 + V$};
        \draw[thick,purple] (1,-2) -- (2,-1) node [right] {$w_6 + V$};
...
\begin{center}
    \begin{tikzcd}[row sep=tiny, column sep=tiny]
        ...
        \text{Map}(S, Z) \arrow[r, leftrightarrow, "\cong" description] & \text{Hom}(V, Z) \\
...
\begin{proposition}
    ...
    \begin{center}
        \begin{tikzcd}[row sep=huge, column sep=huge]
            V \arrow[hook, r, "\iota"] \arrow[dr, "0"] \arrow[rr, "0", bend left] & W \arrow[d, "\pi"] \arrow[r, "\phi"] & Z \\
            & \quotient{W}{V} \arrow[ur, "\tilde{\phi}", dashed] &
        \end{tikzcd}
    \end{center}
