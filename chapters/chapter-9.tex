...
Then we claim that any invertible matrix $A$ can be uniquely decomposed as $A = P U$ for some $P \in \mathsf{H}_n^{> 0} (\mathbb{C})$ and $U \in \Uni(n)$, and we call this the \emph{polar decomposition}\index{polar decomposition} of $A$.
...
\begin{center}
	\begin{tikzcd}
		...
		\Span\{ \vec e_1, \cdots, \vec e_r \} \oplus \Span\{ \vec e_{r+1}, \cdots, \vec e_n \} & \Span\{ \vec e_1, \cdots, \vec e_r \} \oplus \Span\{ \vec e_{r+1}, \cdots, \vec e_m \}
	\end{tikzcd}
\end{center}
