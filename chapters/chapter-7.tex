...
\begin{definition}[Normal Operator]
	A linear operator $N : V \to V$ is called a \emph{normal operator}\index{normal operator} if:
	\[
...
Such a structure is called an \emph{complex structure}\index{complex structure} on $V_\R$.
...
\begin{corollary}
	...
	The pair $(r, s)$ is called the \emph{signature}\index{signature} of the Hermitian form.
